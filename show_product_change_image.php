                        ...
                        <div class="border bg-white p-1">
                            ...
                            <div class="text-center">
                                ...
                                <div class="d-inline-block mr-1">
                                    <a class="color-link" href="#" data-color="<?php echo $product['MAIN_PRO_COLOR']; ?>" data-image="<?php echo $product['MAIN_PRO_IMAGE']; ?>" data-product-id="<?php echo $product['MAIN_PRODUCT_ID']; ?>">
                                ...
                                <?php foreach ($product['relatedProducts'] as $relatedProduct) : ?>
                                    <?php if ($relatedProduct['PRODUCT_FEATURE_TYPE'] === 'COLOR') : ?>
                                        <div class="d-inline-block mr-1">
                                            <a class="color-link" href="#" data-color="<?php echo $relatedProduct['COLOR']; ?>" data-image="<?php echo $relatedProduct['PRODUCT_IMAGE']; ?>" data-product-id="<?php echo $product['MAIN_PRODUCT_ID']; ?>">
